...
model = joblib.load(os.path.join(ai_model_path,'RandomForestClassifier_rec_68.pkl'))
# model = joblib.load(urlopen(storage+'RandomForestClassifier_rec_68.pkl'))
# print(os.path.join(ai_model_path,'RandomForestClassifier_rec_68.pkl'))

    
bow_file = os.path.join(ai_model_path,'vocabulary.pkl')
# bow_file = urlopen(storage+'vocabulary.pkl')

bow = CountVectorizer(analyzer=text_process, vocabulary=joblib.load(bow_file))
    
tfidf_file = os.path.join(ai_model_path,'tfidf.pkl')
