...
def google_search(query, top = None, period: str = None, start_date = None,
    ...
    :param str start_date: start date of result in the format "DD/MM/YYYY"
    :param str end_date: end date of result in the format "DD/MM/YYYY"
    ...
    while count>0:
        ...
        search_url= f'https://www.google.ng/search?q={query}&start={start}&tbs={tbs}&num={num}&source=lnms'
        if type == 'news':
            search_url += '&tbm=nws'
